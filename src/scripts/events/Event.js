...
export const Event = (obj) => {
    return `
      <article id="event-${obj.id}">
        ...
        <button id="edit-event-${obj.id}" type="button" class="btn btn-primary text-sm my-auto me-1 mb-0">Edit</button>
        <button id="delete-event-${obj.id}" type="button" class="btn btn-primary text-sm my-auto me-1 mb-0">Delete</button>
      </article>
    `;
  }
